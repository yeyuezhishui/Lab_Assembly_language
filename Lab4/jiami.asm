...
data segment use16
	...
	bossName db 'C' xor 'A', 'a' xor 'B', 'i' xor 'C', ' ' xor 'D'
			 db 'B' xor 'E', 'o' xor 'F', 'w' xor 'G', 'e' xor 'H', 'n' xor 'I'
	nameLength = $ - bossName
	bossPass db 't' xor 'J', 'e' xor 'K', 's' xor 'L', 't' xor 'M'
	pwdLength = $ - bossPass

    key db 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I'
    keypwd db 'J', 'K', 'L', 'M'
	...
	shop1 db 'SHOP1, ', '$'
	goodsInfo1 dw 5 xor 'A', 8, 20, 15, 0
			  dw 4 xor 'A', 5, 25, 10, 0
			  dw 2 xor 'A', 6, 50, 15, 0
	
	shop2 db 'SHOP2, ', '$'
	goodsInfo2 dw 5 xor 'A', 8, 20, 15, 0
			  dw 4 xor 'A', 5, 25, 10, 0
			  dw 2 xor 'A', 6, 50, 15, 0 
